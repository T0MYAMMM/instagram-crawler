...
from crawlers.exceptions import ClientNotFoundError, StoryNotFound, UserNotFound
from crawlers.extractors import (
    extract_story_gql,
    extract_story_v1,
    extract_user_short,
)
from crawlers.types import Story, UserShort
...
class StoryMixin:
    ...
    def story_download_by_url(
        ...
        assert fname, (
            ...
            """Read the documentation https://subzeroid.github.io/crawlers/usage-guide/story.html"""
        )
