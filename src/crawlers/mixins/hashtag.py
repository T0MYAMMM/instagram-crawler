...
from crawlers.extractors import (
    extract_hashtag_gql,
    extract_hashtag_v1,
    extract_media_v1,
)
from crawlers.types import Hashtag, Media
from crawlers.utils import dumps
...
class HashtagMixin:
    ...
    """
    hashtag_info_a1_url = "/explore/tags/{name}/"
    hashtag_info_v1_url = "https://i.instagram.com/api/v1/tags/{name}/info/"
    hashtag_medias_a1_url = "/explore/tags/{name}/"
    hashtag_medias_v1_url = "https://i.instagram.com/api/v1/tags/{name}/sections/"
    ...
    def hashtag_info_v1(self, name: str) -> Hashtag:
        ...
        return result #extract_hashtag_v1(result)
    ...
    def hashtag_info(self, name: str) -> Hashtag:
        ...
        try:
            ...
            # such this - https://github.com/subzeroid/crawlers/issues/364
